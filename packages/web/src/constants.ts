...
export const HA_INTEGRATION_URL = 'https://github.com/sphings79/amberchest-home-assistant';

/** AmberChest as an add-on for Home Assistant OS. */
export const HA_ADDON_URL = 'https://github.com/sphings79/amberchest-ha-app';
